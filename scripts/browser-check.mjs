...
try {
 ...
 await page.addInitScript(()=>{
  window.SpeechRecognition=class{start(){} stop(){this.onresult?.({resultIndex:0,results:[Object.assign([{transcript:window.testTranscript??'Estoy muy feliz'}],{isFinal:true})]});this.onend?.();}abort(){}};
